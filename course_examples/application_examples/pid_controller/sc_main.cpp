...
int sc_main(int argc, char* argv[])
{
  ...
  sca_util::sca_trace_file* pid_vcd = sca_util::sca_create_vcd_trace_file("pid_controller.vcd");
  sca_util::sca_trace(pid_vcd, in, "in");
  sca_util::sca_trace(pid_vcd, out1, "out1");
  sca_util::sca_trace(pid_vcd, out2, "out2");
  ...
  sca_util::sca_close_vcd_trace_file(pid_vcd);
